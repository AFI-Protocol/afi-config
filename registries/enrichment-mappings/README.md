...
| `froggy-trend-pullback--1.3.0.json` | `148fa7be3c87a3cd17e0e61d2407eacc7717a84fdea083d790537790eef65f35` | DEM-GOV DEM-PRODUCER-HTF (owner-authorized 2026-08-25), 2026-08-25: 1.2.0 + `weeklyBias`/`dailyBias` recoded from `technical.htf.{weekly,daily}.trendBias`. Earlier versions stay byte-identical |
