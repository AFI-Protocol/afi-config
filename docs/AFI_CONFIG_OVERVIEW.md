...
Draft schemas for the District 2 canonical data/provenance boundary (authorized by District 2 D-17 as D2 M1: afi-config schema drafts and tests only): CanonicalHash v1, EvidenceRef v1, SourceDisclosureProfile v1, EnrichmentProvenance v1, AnalystInputEnvelope v1, ScoredSignal v1 projection, ProvenanceRecord v1, ReplayProfile v1, and TradePlan v1 / SignalLevels v1.
