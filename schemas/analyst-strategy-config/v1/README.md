...
| `mappingRef` | **yes** (required since DEM-BIND step (e1), D-DEM-2(5)(e)) | `{ mappingId, version }` — selects the registered enrichment mapping (DEM-GOV D-DEM-2(3)); no hash member — identity rides `analystConfigHash` (D-DEM-6(2)) |
